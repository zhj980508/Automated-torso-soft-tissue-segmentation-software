...
VertebraName_526 = ['C1','C2','C3','C4','C5','C6','C7',
                    'T1','T2','T3','T4','T5','T6','T7','T8','T9','T10','T11','T12',
                    'L1','L2','L3','L4','L5']
SliceNumber_526 = ['111078','111058','111022','110990','110962','110937','110912','110884','110854',
...
VertebraName_BED = 'C1'
data_HU_BED_SoftTissue = LoadImageData_HU_SoftTissue(VertebraName_BED,Vertebra_Filename_526_list,dir_526)
...
VertebraName = 'L2'
data_HU_SoftTissue = LoadImageData_HU_SoftTissue(VertebraName,Vertebra_Filename_526_list,dir_526)
...
dir_526_Markers = r'..\CT Scans\00526M\Markers'
ds_eva,data_eva = FindOriginalDataByVertebraName(VertebraName,Vertebra_Filename_526_list,dir_526_Markers)
...
cv.imwrite('526_'+VertebraName+'_SoftTissue.png', data_HU_SoftTissue_Color)
