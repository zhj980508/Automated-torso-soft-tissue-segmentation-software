...
VertebraName_BED = 'C1'
ds_BED,data_BED = FindOriginalDataByVertebraName(VertebraName_BED,Vertebra_Filename_526_list,dir_526)
...
VertebraName = 'L2'
ds,data = FindOriginalDataByVertebraName(VertebraName,Vertebra_Filename_526_list,dir_526)
...
kernel = cv.getStructuringElement(cv.MORPH_ELLIPSE,(1,1)) # the unit of close operation: circle(r=3)
...
#fg[250,60] = 1 # left arm
fg[180,480]= 1 # torso
fg[200,430] = 1 # right arm
k_fg = cv.getStructuringElement(cv.MORPH_ELLIPSE,(10,10))
